...
showUpSlider.init();
var modelesSlider = new _modules_Slider_MiniSlider__WEBPACK_IMPORTED_MODULE_1__["default"]({
...
feedSlider.init();
var showUpPlayer = new _modules_VideoPlayer__WEBPACK_IMPORTED_MODULE_2__["default"]('.showup .play', '.overlay');
showUpPlayer.init();
var difference = new _modules_Difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item');
difference.init();
var joinForm = new _modules_Form__WEBPACK_IMPORTED_MODULE_4__["default"]('.join__evolution .form', 'assets/question.php', 'POST');
joinForm.init();
var scheduleForm = new _modules_Form__WEBPACK_IMPORTED_MODULE_4__["default"]('.schedule__form .form', 'assets/question.php', 'POST');
scheduleForm.init(); //secod page
...
var modulVideo = new _modules_VideoPlayer__WEBPACK_IMPORTED_MODULE_2__["default"]('.module__video-item .play', '.overlay');
modulVideo.init();
var showInfo = new _modules_ShowInfo__WEBPACK_IMPORTED_MODULE_5__["default"]('.module__info-show .plus', '.msg');
showInfo.init();
...
function () {
  ...
  _createClass(Difference, [{
    key: "hideElem",
    value: function hideElem(SomeItem) {
      SomeItem.forEach(function (item, i, arr) {
        if (i !== arr.length - 1) {
    ...
    value: function init() {
      ...
      try {
        ...
        this.form.addEventListener('submit', function (e) {
          ...
          _this.postData(formData).then(function (res) {
            console.log(res);
...
/*#__PURE__*/
function () {
  function ShowInfo(triggers, msg) {
    ...
    value: function init() {
      ...
      this.btn.forEach(function (btn) {
        btn.addEventListener('click', function () {
          _this.msg.classList.add('animated');

          if (window.getComputedStyle(_this.msg).display === 'none') {
            _this.msg.style.display = 'block';

            _this.msg.classList.add('slideInDown');
          } else {
            _this.msg.style.display = 'none';
          }
        });
      });
    }
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function nextSlide() {
      var active = this.slides[this.slides.length - (1 + this.btns)];
